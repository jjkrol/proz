...
/**
 * The Class SaveBuildingMeasurementEvent.
 */
public class SaveBuildingMeasurementEvent extends BuildingMeasurementsEvent {

	/** The measurement mockup. */
	private final BuildingMeasurementMockup measurementMockup;

	/**
	 * Instantiates a new save building measurement event.
	 * 
	 * @param measurementMockup
	 *            the measurement mockup
	 */
	public SaveBuildingMeasurementEvent(
